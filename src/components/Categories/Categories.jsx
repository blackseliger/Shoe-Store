...
import { changeSelection, request } from '../../redux/categories/categoriesSlice';
...
export default function Categories(props) {
  ...
  const changeSelectionToAll = (value) => {
    categories.forEach((o) => {
      dispatch(changeSelection({ id: o.id, selected: value }));
    });
  };
  ...
  const handleClick = (evt, item) => {
    ...
    changeSelectionToAll(false);
    dispatch(changeSelection({ id, selected: !selected }));
